import { Brand, BRANDS_QUERY_RESULT } from "@/sanity.types";
...
const BrandList = ({ brands, selectedBrand, setSelectedBrand }: Props) => {
  return (
    <div className="w-full bg-white p-5">
      <Title className="text-base font-black">Product Brands</Title>
        ...
        {brands?.map((brand) => (
          ...
          >
            <RadioGroupItem
              ...
              className="rounded-sm border-shop_dark_green/50"
            />
            <Label
